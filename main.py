...
def CreateLayout():
    ...
    app_mode = st.sidebar.selectbox("Seleccione una página:",
                                    ["Introducción", "Requerimientos", "Proveedores", "Productos"])
